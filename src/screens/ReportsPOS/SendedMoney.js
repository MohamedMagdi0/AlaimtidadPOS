  ...
  if (TokenStatus == false) {
    ...
    return (
      <View style={styles.containerBig}>
        <Text style={styles.nodata}>لا يوجد رصيد مرسل </Text>
      </View>
    );
          ...
          <ScrollView>
            <ImageBackground
              ...
              <View style={{marginTop: hp('1%')}}>
                ...
                <View
                  style={{flex: 2, flexDirection: 'row', marginTop: hp('2%')}}>
